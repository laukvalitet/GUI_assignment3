<template>
    <div>
        ...
        <b-list-group>
            ...
            <b-list-group-item>StartDate: {{new Date(job.startDate).toLocaleDateString()}}</b-list-group-item>
        ...
        <h4>Models:</h4>
        <b-list-group>
            <b-list-group-item v-for="model in job.models" :key="model.efModelId">First name: {{model.firstName}} <br> Last name: {{model.lastName}} <br> 
            Email: {{model.email}} <br> Phone: {{model.phoneNo}} </b-list-group-item>
